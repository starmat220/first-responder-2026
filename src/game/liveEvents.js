...
const LIVE_EVENT_CATALOG = [
  ...
  {
    id: 'port-security-operation',
    title: 'Port Security Operation',
    summary: 'Increased enforcement and response demand around port and ferry corridors.',
    minResolved: 28,
    durationMinutes: 8,
    departments: [DEPARTMENTS.police.id, DEPARTMENTS.fire.id, DEPARTMENTS.ems.id],
    effects: {
      ...
      responseTargetMultiplier: 0.95,
      chainChanceBonus: 0.1,
      mutualAidCostMultiplier: 0.93,
    },
  },
  {
    id: 'winter-ops-surge',
    title: 'Winter Ops Surge',
    summary: 'Snow/ice operations are driving heavy tow and public works workload.',
    minResolved: 26,
    durationMinutes: 9,
    departments: [DEPARTMENTS.tow.id, DEPARTMENTS.public_works.id, DEPARTMENTS.police.id],
    weatherBias: ['snow', 'blizzard'],
    effects: {
      intervalMultiplier: 0.8,
      maxActiveBias: 2,
      rewardMultiplier: 1.1,
      responseTargetMultiplier: 0.93,
      chainChanceBonus: 0.12,
      mutualAidCostMultiplier: 0.88,
    },
  },
  {
    id: 'festival-weekend',
    title: 'Festival Weekend',
    summary: 'Large crowd movement is increasing calls in core service areas.',
    minResolved: 16,
    durationMinutes: 7,
    departments: [DEPARTMENTS.police.id, DEPARTMENTS.ems.id, DEPARTMENTS.tow.id],
    effects: {
      intervalMultiplier: 0.87,
      maxActiveBias: 1,
      rewardMultiplier: 1.07,
      responseTargetMultiplier: 0.97,
      chainChanceBonus: 0.09,
      mutualAidCostMultiplier: 0.95,
    },
  },
]
