...
const BUILDING_TIER_OVERRIDES = {
  ...
  [STATION_TYPES.fire_station.id]: { minLevel: 1, minResolved: 0 },
  [STATION_TYPES.fire_station_small.id]: { minLevel: 1, minResolved: 0 },
  [STATION_TYPES.ems_station.id]: { minLevel: 1, minResolved: 0 },
  [STATION_TYPES.ems_station_small.id]: { minLevel: 1, minResolved: 0 },
  [STATION_TYPES.tow_yard.id]: { minLevel: 1, minResolved: 0 },
